...
import prog.ud7.aparatoselectricos.Electrodomestico;
...
public class TestAparatoElectrico {
    ...
    public static void main(String[] args) {
        ...
        aparatos[0] = new Lavadora(5, Electrodomestico.Color.BLANCO, Electrodomestico.ConsumoEnergetico.F, 100, "Bosch", "V1", 5, "1234A");
        aparatos[1] = new Lavadora(12, Electrodomestico.Color.BLANCO, Electrodomestico.ConsumoEnergetico.F, 100, "Fagor", "F22", 5, "1234B");
        aparatos[2] = new Television(45, Electrodomestico.Color.BLANCO, Electrodomestico.ConsumoEnergetico.F, 100, "LG", "SuperGuay", 5, "1234C");
        aparatos[3] = new Television(14, Electrodomestico.Color.BLANCO, Electrodomestico.ConsumoEnergetico.F, 100, "Sony", "MásChulaA", 5, "1234D");
